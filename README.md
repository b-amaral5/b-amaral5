...
| :--- | :--- | :--- | :--- |
| **Nucbox K12** | Windows 11 Pro / Windows Server 2025 / Kali Linux | Primary Domain Controller (DC) / Server | Tailscale / VMware Workstation Pro |
| **ThinkPad T14 Gen4** | Windows 11 Enterprise | x64 Management Workstation (RSAT) | Tailscale / Hyper-V |
| **M1 Mac** | macOS / Kali Linux | Pentesting / ARM Architecture Client Testing | Tailscale / VMware Fusion |
